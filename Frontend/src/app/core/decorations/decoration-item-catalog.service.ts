...
import { loadVanillaItemRegistry, VanillaItemRegistry } from '../items/vanilla-item-registry';
...
export class DecorationItemCatalogService {
  ...
  private async load(provider: Parameters<ItemCatalog['load']>[0]): Promise<void> {
